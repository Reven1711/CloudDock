...
// Platform admin management endpoints (PLATFORM ADMIN ONLY)
router.get("/platform-admin/admins", verifyPlatformAdmin, getAllPlatformAdmins);
router.post("/platform-admin/admins", verifyPlatformAdmin, createPlatformAdmin);
